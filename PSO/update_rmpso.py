...
import random
import math
GLOBAL_PARAMS = {'N_RUNS': 30, 'D': 5, 'N': 40, 'w': 0.7, 'c1': 2.0, 'c2': 2.0, 'max_iterations': 1000}
...
ALL_FUNCTION_CONFIGS = [{'id': 1, 'name': 'Sphere', 'func': sphere, 'min_range': -5.12, 'max_range': 5.12, 'params': {}}, {'id': 2, 'name': 'Sum of Squares', 'func': sum_of_squares, 'min_range': -10.0, 'max_range': 10.0, 'params': {}}, {'id': 3, 'name': 'Sum Diff Powers', 'func': sum_of_different_powers, 'min_range': -1.0, 'max_range': 1.0, 'params': {}}, {'id': 4, 'name': 'Step', 'func': step, 'min_range': -100.0, 'max_range': 100.0, 'params': {}}, {'id': 5, 'name': 'Brown', 'func': brown, 'min_range': -1.0, 'max_range': 4.0, 'params': {}}, {'id': 6, 'name': 'Zakharov', 'func': zakharov, 'min_range': -5.0, 'max_range': 10.0, 'params': {}}, {'id': 7, 'name': 'Dixon-Price', 'func': dixon_price, 'min_range': -10.0, 'max_range': 10.0, 'params': {}}, {'id': 8, 'name': 'Schumer-Steiglitz', 'func': schumer_steiglitz, 'min_range': -1.21, 'max_range': 1.21, 'params': {}}, {'id': 9, 'name': 'Csendes', 'func': csendes, 'min_range': -1.0, 'max_range': 1.0, 'params': {}}, {'id': 10, 'name': 'Sixth Power', 'func': sixth_power, 'min_range': -10.0, 'max_range': 10.0, 'params': {}}, {'id': 11, 'name': 'Powell', 'func': powell, 'min_range': -4.0, 'max_range': 5.0, 'params': {}}, {'id': 12, 'name': 'Quartic', 'func': quartic, 'min_range': -1.28, 'max_range': 1.28, 'params': {}}, {'id': 13, 'name': 'Rotated Hyper Ellipsoid', 'func': rotated_hyper_ellipsoid, 'min_range': -65.536, 'max_range': 65.536, 'params': {}}, {'id': 14, 'name': 'Discus', 'func': discus, 'min_range': -5.12, 'max_range': 5.12, 'params': {}}, {'id': 15, 'name': 'Exponential', 'func': exponential, 'min_range': -1.0, 'max_range': 1.0, 'params': {}}]
    ...
    try:
        for part in selection_str.split(','):
            if '-' in part.strip():
                ...
                selected_ids.add(int(part.strip()))
    except:
